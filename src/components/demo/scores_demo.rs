...
pub fn ScoresDemo(
    ...
    let score_number_tpl = Memo::new(move |_| tr!("api-demo-score-number", {"number" => "{$number}"}));
                ...
                Ok(scores) => {
                    ...
                    if scores.is_empty() {
                        ...
                        for (idx, score) in scores.iter().enumerate() {
                            ...
                            // Combo
                            result_str.push_str(&combo_template.replace("{$combo}", &score.maxcombo));
                            result_str.push_str("\n");
                            ...
                            // Mods
                            result_str.push_str(&mods_template.replace("{$mods}", &score.enabled_mods));
                            result_str.push_str("\n");
                            ...
                            // Replay available
                            let replay_status = if score.replay_available == "1" { "Available" } else { "Not Available" };
                            result_str.push_str(&replay_template.replace("{$replay}", replay_status));
                        }
    ...
    view! {
        <div class="mb-6 space-y-4">
            ...
            <div>
                <label for="beatmap-id-scores" class="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-200">
            ...
            <div>
                <label for="username-scores" class="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                // Mode Select
                <div>
                    <label for="mode-scores" class="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-200">
                ...
                // Limit Input
                <div>
                    <label for="limit-scores" class="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-200">
