...
pub fn UserRecentDemo(
    ...
    view! {
        <div class="mb-6 space-y-4">
            ...
            <div>
                <label for="username-recent" class="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                // Mode Select
                <div>
                    <label for="mode" class="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-200">
                ...
                // Limit Input
                <div>
                    <label for="limit" class="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-200">
