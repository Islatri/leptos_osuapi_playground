                ...
                Ok(bests) => {
                    ...
                    if bests.is_empty() {
                        ...
                        for (idx, best) in bests.iter().enumerate() {
                            ...
                            // Beatmap ID
                            result_str
                                .push_str(&beatmap_id_template.replace("{$id}", &best.beatmap_id));
                            result_str.push_str("\n");
                            ...
                            // Combo
                            result_str
                                .push_str(&combo_template.replace("{$combo}", &best.maxcombo));
                            result_str.push_str("\n");
                            ...
                            // Mods
                            result_str
                                .push_str(&mods_template.replace("{$mods}", &best.enabled_mods));
                            result_str.push_str("\n");
