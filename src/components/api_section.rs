                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-6 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="text-xl font-semibold ml-4 dark:text-gray-200">谱面 API</h3>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-2 text-sm font-mono">
                                ...
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-3 py-1.5 transition-colors hover:bg-pink-100 dark:hover:bg-pink-900 dark:text-gray-200">lookup_beatmap</div>
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-3 py-1.5 transition-colors hover:bg-pink-100 dark:hover:bg-pink-900 dark:text-gray-200">get_scores</div>
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-3 py-1.5 transition-colors hover:bg-pink-100 dark:hover:bg-pink-900 dark:text-gray-200">get_replay</div>
                            </div>
                        </div>
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-6 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="text-xl font-semibold ml-4 dark:text-gray-200">用户 API</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-6">
                            ...
                            <div class="grid grid-cols-2 gap-2 text-sm font-mono">
                                ...
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-3 py-1.5 transition-colors hover:bg-purple-100 dark:hover:bg-purple-900 dark:text-gray-200">get_user_scores</div>
                            </div>
                        </div>
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-6 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="text-xl font-semibold ml-4 dark:text-gray-200">分数 API</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-6">
                            ...
                            <div class="grid grid-cols-2 gap-2 text-sm font-mono">
                                ...
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-3 py-1.5 transition-colors hover:bg-indigo-100 dark:hover:bg-indigo-900 dark:text-gray-200">get_user_scores</div>
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-3 py-1.5 transition-colors hover:bg-indigo-100 dark:hover:bg-indigo-900 dark:text-gray-200">get_replay</div>
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-3 py-1.5 transition-colors hover:bg-indigo-100 dark:hover:bg-indigo-900 dark:text-gray-200">get_score_info</div>
                            </div>
                        </div>
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-6 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="text-xl font-semibold ml-4 dark:text-gray-200">排名 API</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-6">
                                获取全球排名, 国家排名和好友排名数据.支持按模式和类型筛选.
                            </p>
                            <div class="grid grid-cols-2 gap-2 text-sm font-mono">
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-3 py-1.5 transition-colors hover:bg-blue-100 dark:hover:bg-blue-900 dark:text-gray-200">get_user_best</div>
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-3 py-1.5 transition-colors hover:bg-blue-100 dark:hover:bg-blue-900 dark:text-gray-200">get_rankings</div>
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-3 py-1.5 transition-colors hover:bg-blue-100 dark:hover:bg-blue-900 dark:text-gray-200">get_country_ranking</div>
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-3 py-1.5 transition-colors hover:bg-blue-100 dark:hover:bg-blue-900 dark:text-gray-200">get_spotlights</div>
                            </div>
                        </div>
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-6 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-4">
                                ...
                                <h3 class="text-xl font-semibold ml-4 dark:text-gray-200">多人游戏 API</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-6">
                            ...
                            <div class="grid grid-cols-2 gap-2 text-sm font-mono">
                                ...
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-3 py-1.5 transition-colors hover:bg-green-100 dark:hover:bg-green-900 dark:text-gray-200">get_matches</div>
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-3 py-1.5 transition-colors hover:bg-green-100 dark:hover:bg-green-900 dark:text-gray-200">get_room</div>
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-3 py-1.5 transition-colors hover:bg-green-100 dark:hover:bg-green-900 dark:text-gray-200">get_scores</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-5 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-semibold ml-3 dark:text-gray-200">谱面 API</h3>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-1.5 text-xs font-mono">
                                ...
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1 transition-colors hover:bg-pink-100 dark:hover:bg-pink-900 dark:text-gray-200">lookup</div>
                            </div>
                        </div>
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-5 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-semibold ml-3 dark:text-gray-200">谱面集 API</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                                获取谱面集信息和其包含的谱面.
                            </p>
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-5 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-semibold ml-3 dark:text-gray-200">更改日志 API</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                                获取游戏更新和变化记录.
                            </p>
                            <div class="grid grid-cols-2 gap-1.5 text-xs font-mono">
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1 transition-colors hover:bg-indigo-100 dark:hover:bg-indigo-900 dark:text-gray-200">get_changelog</div>
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1 transition-colors hover:bg-indigo-100 dark:hover:bg-indigo-900 dark:text-gray-200">lookup_build</div>
                            </div>
                        </div>
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-5 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-semibold ml-3 dark:text-gray-200">聊天 API</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                                获取聊天历史和发送消息.
                            </p>
                            <div class="grid grid-cols-2 gap-1.5 text-xs font-mono">
                                ...
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1 transition-colors hover:bg-blue-100 dark:hover:bg-blue-900 dark:text-gray-200">send_message</div>
                            </div>
                        </div>
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-5 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-semibold ml-3 dark:text-gray-200">评论 API</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                                获取和发布评论内容.
                            </p>
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-5 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-semibold ml-3 dark:text-gray-200">事件 API</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                                获取最新事件和动态.
                            </p>
                            <div class="grid grid-cols-2 gap-1.5 text-xs font-mono">
                                ...
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1 transition-colors hover:bg-green-100 dark:hover:bg-green-900 dark:text-gray-200">get_feeds</div>
                            </div>
                        </div>
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-5 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-semibold ml-3 dark:text-gray-200">论坛 API</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                                获取论坛主题和帖子.
                            </p>
                            <div class="grid grid-cols-2 gap-1.5 text-xs font-mono">
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1 transition-colors hover:bg-amber-100 dark:hover:bg-amber-900 dark:text-gray-200">get_topic</div>
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1 transition-colors hover:bg-amber-100 dark:hover:bg-amber-900 dark:text-gray-200">get_posts</div>
                            </div>
                        </div>
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-5 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-semibold ml-3 dark:text-gray-200">主页 API</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                                获取个人主页数据.
                            </p>
                            <div class="grid grid-cols-2 gap-1.5 text-xs font-mono">
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1 transition-colors hover:bg-orange-100 dark:hover:bg-orange-900 dark:text-gray-200">get_news</div>
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1 transition-colors hover:bg-orange-100 dark:hover:bg-orange-900 dark:text-gray-200">get_updates</div>
                            </div>
                        </div>
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-5 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-semibold ml-3 dark:text-gray-200">比赛 API</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                                获取官方比赛信息.
                            </p>
                            <div class="grid grid-cols-2 gap-1.5 text-xs font-mono">
                                ...
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1 transition-colors hover:bg-rose-100 dark:hover:bg-rose-900 dark:text-gray-200">get_results</div>
                            </div>
                        </div>
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-5 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-semibold ml-3 dark:text-gray-200">多人游戏 API</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                                获取和管理多人游戏房间.
                            </p>
                            <div class="grid grid-cols-2 gap-1.5 text-xs font-mono">
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1 transition-colors hover:bg-emerald-100 dark:hover:bg-emerald-900 dark:text-gray-200">get_room</div>
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1 transition-colors hover:bg-emerald-100 dark:hover:bg-emerald-900 dark:text-gray-200">create_room</div>
                            </div>
                        </div>
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-5 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-semibold ml-3 dark:text-gray-200">新闻 API</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                                获取游戏最新新闻.
                            </p>
                            <div class="grid grid-cols-2 gap-1.5 text-xs font-mono">
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1 transition-colors hover:bg-blue-100 dark:hover:bg-blue-900 dark:text-gray-200">get_news</div>
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1 transition-colors hover:bg-blue-100 dark:hover:bg-blue-900 dark:text-gray-200">get_post</div>
                            </div>
                        </div>
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-5 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-semibold ml-3 dark:text-gray-200">通知 API</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                                获取个人通知信息.
                            </p>
                            <div class="grid grid-cols-2 gap-1.5 text-xs font-mono">
                                ...
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1 transition-colors hover:bg-violet-100 dark:hover:bg-violet-900 dark:text-gray-200">mark_read</div>
                            </div>
                        </div>
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-5 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-semibold ml-3 dark:text-gray-200">排名 API</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                                获取详细排名数据.
                            </p>
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-5 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-semibold ml-3 dark:text-gray-200">分数 API</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                                获取详细分数信息.
                            </p>
                            <div class="grid grid-cols-2 gap-1.5 text-xs font-mono">
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1 transition-colors hover:bg-red-100 dark:hover:bg-red-900 dark:text-gray-200">get_score</div>
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-5 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-semibold ml-3 dark:text-gray-200">用户 API</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                                获取用户详细信息.
                            </p>
                            <div class="grid grid-cols-2 gap-1.5 text-xs font-mono">
                                ...
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1 transition-colors hover:bg-purple-100 dark:hover:bg-purple-900 dark:text-gray-200">get_scores</div>
                            </div>
                        </div>
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-5 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-semibold ml-3 dark:text-gray-200">维基 API</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                                获取维基页面内容.
                            </p>
                            <div class="grid grid-cols-2 gap-1.5 text-xs font-mono">
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1 transition-colors hover:bg-teal-100 dark:hover:bg-teal-900 dark:text-gray-200">get_page</div>
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1 transition-colors hover:bg-teal-100 dark:hover:bg-teal-900 dark:text-gray-200">search</div>
                            </div>
                        </div>
                        ...
                        <div class="card bg-white dark:bg-gray-800 hover:shadow-xl transition duration-300 p-5 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
                            ...
                            <div class="flex items-center mb-3">
                                ...
                                <h3 class="text-lg font-semibold ml-3 dark:text-gray-200">OAuth API</h3>
                            </div>
                            <p class="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                                处理 OAuth 2.0 认证流程.
                            </p>
                            <div class="grid grid-cols-2 gap-1.5 text-xs font-mono">
                                <div class="bg-gray-100 dark:bg-gray-700 rounded-md px-2 py-1 transition-colors hover:bg-red-100 dark:hover:bg-red-900 dark:text-gray-200">get_token</div>
